...
circuit samples coefficients = y
 where
  y_delay_s1 = register (0 :: Unsigned 18) ((\value_0 value_1 -> (resize ((resize ((resize ((value_0) !! (0 :: Index 4)) :: Unsigned 16) * (resize ((value_1) !! (0 :: Index 4)) :: Unsigned 16)) :: Unsigned 17) + (resize ((resize ((value_0) !! (1 :: Index 4)) :: Unsigned 16) * (resize ((value_1) !! (1 :: Index 4)) :: Unsigned 16)) :: Unsigned 17)) :: Unsigned 18) + (resize ((resize ((resize ((value_0) !! (2 :: Index 4)) :: Unsigned 16) * (resize ((value_1) !! (2 :: Index 4)) :: Unsigned 16)) :: Unsigned 17) + (resize ((resize ((value_0) !! (3 :: Index 4)) :: Unsigned 16) * (resize ((value_1) !! (3 :: Index 4)) :: Unsigned 16)) :: Unsigned 17)) :: Unsigned 18)) <$> samples <*> coefficients)
  y = y_delay_s1
