...
circuit a b c = y
 where
  y_pipe_s1 = register (0 :: Unsigned 17) ((\value_0 value_1 value_2 -> (resize ((resize (value_0) :: Unsigned 16) * (resize (value_1) :: Unsigned 16)) :: Unsigned 17) + (resize (value_2) :: Unsigned 17)) <$> a <*> b <*> c)
  y_pipe_s2 = register (0 :: Unsigned 17) (y_pipe_s1)
  y = y_pipe_s2
