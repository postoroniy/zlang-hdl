...
circuit a b c = y
 where
  zlang_pipe_1_s1 = register (0 :: Unsigned 17) ((\value_0 value_1 value_2 -> (resize ((resize (value_0) :: Unsigned 16) * (resize (value_1) :: Unsigned 16)) :: Unsigned 17) + (resize (value_2) :: Unsigned 17)) <$> a <*> b <*> c)
  y = (\value_0 -> (let zlangDspMac = (value_0) in zlangDspMac)) <$> zlang_pipe_1_s1
