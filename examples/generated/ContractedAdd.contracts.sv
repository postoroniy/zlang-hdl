...
module ContractedAdd__zlang_contracts (
  ...
  operands_bounded: assume property (@(posedge clk) disable iff (rst == 1'b1) (1'($unsigned(((1'($unsigned(($unsigned(4'($unsigned(a))) < $unsigned(4'($unsigned(4'd8))))))) & (1'($unsigned(($unsigned(4'($unsigned(b))) < $unsigned(4'($unsigned(4'd8))))))))))));
